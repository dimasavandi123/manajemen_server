				...
				<div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						...
						<div class="text-center mt-2">
							...
							<p class="lead">
								Daftarkan Akun Anda Untuk Melanjutkan Ke-halaman Berikutnya
							</p>
						</div>
								...
								<div class="m-sm-3">
									<form action="/auth/register" method="POST">
                                        ...
                                        <div class="mb-2">
											...
											<input class="form-control form-control-lg" type="text" name="name" placeholder="Enter your nama" />
										</div>
                                        <div class="mb-2">
											<label class="form-label">Usernama</label>
											<input class="form-control form-control-lg" type="text" name="username" placeholder="Enter your usernama" />
										</div>
										<div class="mb-2">
